...
router.get('/muslim/tahlil', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/data/dataTahlil.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/wirid', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/data/dataWirid.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/ayatkursi', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/data/dataAyatKursi.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/doaharian', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/data/dataDoaHarian.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/bacaanshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/data/dataBacaanShalat.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/data/NiatAshar.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/kisahnabi', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/data/dataKisahNabi.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/asmaulhusna', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/data/dataAsmaulHusna.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatshubuh', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/data/NiatShubuh.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatdzuhur', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/data/NiatDzuhur.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatmaghrib', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/data/NiatMaghrib.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatisya', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/data/NiatIsya.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/cyberspace', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/CyberSpace.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/teknologi', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/Technology.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/muslim', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/Islamic.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/programming', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/CupzAssetsFormGithubCupzTzy/My-SQL-Results/main/Programming.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/jadwalshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/ground67/Zhirrr-Database/main/adzan/${kota}/2021/03.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/filmapik/search', async (req, res, next) => {
    ...
    if (!film) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter film"})
       ...
       fetch(encodeURI(`https://api-filmapik.herokuapp.com/search?q=${film}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/filmapik/kategori', async (req, res, next) => {
    ...
    if (!film) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter film"})
       ...
       fetch(encodeURI(`https://api-filmapik.herokuapp.com/category?search=${film}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/filmapik/play', async (req, res, next) => {
    ...
    if (!id) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter id"})
       ...
       fetch(encodeURI(`https://api-filmapik.herokuapp.com/play?id=${id}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/filmapik/terbaru', async (req, res, next) => {
	...
	if(apikeyInput != 'Alphabot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api-filmapik.herokuapp.com/latest`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/search', async (req, res, next) => {
    ...
    if (!film) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter film"})
       ...
       fetch(encodeURI(`https://api-lk21.herokuapp.com/search?query=${film}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/year', async (req, res, next) => {
    ...
    if (!tahun) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter tahun"})
       ...
       fetch(encodeURI(`https://api-lk21.herokuapp.com/year?year=${tahun}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/country', async (req, res, next) => {
    ...
    if (!negara) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter negara"})
       ...
       fetch(encodeURI(`https://api-lk21.herokuapp.com/country?country=${negara}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/genre', async (req, res, next) => {
    ...
    if (!tipe) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter tipe"})
       ...
       fetch(encodeURI(`https://api-lk21.herokuapp.com/genre?genre=${tipe}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
